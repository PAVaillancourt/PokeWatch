...
class LegendView extends Ui.WatchFace {
	...
	var link = new Ui.Bitmap({
		:rezId=>Rez.Drawables.link,
        :locX=>105,
        :locY=>90
    });
    ...
    function onLayout(dc) {
    	...
    	// Load resources for Link (type BitmapResource)
    	//var linkResource = Ui.loadResource(Rez.Drawables.link);
    	//link.setBitmap("link");
